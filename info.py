...
BOT_TOKEN = environ.get('BOT_TOKEN', "7907940805:AAEWmGsocH8fFzMyEGw1IyE8jQyQrO1yDNQ")


# This Pictures Is For Start Message Picture, You Can Add Multiple By Giving One Space Between Each.
PICS = (environ.get('PICS', 'https://envs.sh/ox8.jpg')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7831382420').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002354637242'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002269179534 -1002312189279').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002409563167') # give your force subscribe channel id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None

# This Channel Is For When User Request File With command or hashtag like - /request or #request
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002411647699')
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None

# This Is Your Bot Support Group Id , Here Bot Will Not Give File Because This Is Support Group.
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002462332114')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002462347262')).split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://acml:acml@cluster0.38t6x.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "acmlclonefilterbot")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'acmlcollection')
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+kwsVMnodWC9lNDhl')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/LUST_LINKZz')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Robin_filter_support_chat') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/Legend_elu')
...
VERIFY_TUTORIAL = environ.get('VERIFY_TUTORIAL', 'https://t.me/Lust_tutorial')
...
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/Lust_tutorial') # How Open Shortner Link Video Link , Channel Link Where You Upload Your Video.
